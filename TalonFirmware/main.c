...
void ADS1299_init() {
    ...
    ADS1299_write_register(ADS1299_REG_CONFIG3, 0xe0);
    sleep_ms(1000);
...
void core1_interrupt_handler(){
    ...
    // printf("%d ", data[19]);
    // printf("%d\t", data[20]);
    // printf("%f ", data_to_voltage(1));
    // printf("%f ", data_to_voltage(2));
    // printf("%f ", data_to_voltage(3));
    // printf("%f ", data_to_voltage(4));
    // printf("%f ", data_to_voltage(5));
    // printf("%f\n", data_to_voltage(6));
    send_data();
